...
MODEL_SAVE_PATH = os.path.join(SAVE_PATH, "gesture_classifier10.pth")
...
# data_array = create_data_array(data_array, frame_num=25, skip_num=3, is_stop=True)
...
pickle.dump(scaler, open(os.path.join(SAVE_PATH, 'motion_scaler10.sav'), 'wb'))

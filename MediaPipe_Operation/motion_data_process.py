...
data = np.loadtxt(os.path.join(SAVE_PATH, 'motion_data_30_unitvec2.txt'))
...
# Save
pickle.dump(scaler, open(os.path.join(SAVE_PATH, 'motion_scaler_10_unitvec.sav'), 'wb'))
with open(os.path.join(SAVE_PATH, 'pca_model_10_unitvec.sav'), mode='wb') as f:
    pickle.dump(pca, f)
# with open(os.path.join(SAVE_PATH, 'forest_model_10_unitvec.sav'), mode='wb') as f:
    # pickle.dump(forest, f)
with open(os.path.join(SAVE_PATH, 'motion_model_10_unitvec.sav'), mode='wb') as f:

...
class BaseMotionRecognition():
    ...
    def __init__(self, data_depth=15, filter_size=None):
        """_summary_
    ...
    def predict_motion(self):
        if self.model_SVM is not None and self.model_NN is None:
        ...
        elif self.model_SVM is None and self.model_NN is not None:
    ...
    def set_motion_model(self, motion_scaler, model_SVM=None, model_NN=None, forest_model=None):
        if model_SVM is None and model_NN is None:
            print("Please input the model.")
        else:

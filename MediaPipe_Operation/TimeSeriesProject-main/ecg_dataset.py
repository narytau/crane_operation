...
class MyTestDataLoader():
    def __init__(self, batch_size) -> None:
        ...
        file_out_test = pd.read_csv(os.path.join(CURRENT_PATH, "mitbih_test.csv"))
...
class myDataLoader():
    def __init__(self, batch_size, x_train, x_val, y_train, y_val) -> None:
        self.batch_size = batch_size
        # file_out_train = pd.read_csv(os.path.join(CURRENT_PATH, "mitbih_train.csv")) 

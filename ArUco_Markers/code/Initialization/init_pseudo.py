...
print(pose_initial_matrix.shape)
dataset = pose_initial_matrix[:, :18]
print(dataset.shape)
...
for missing_index in range(N):
    ...
    print(relative_vectors.shape, y.shape)
...
np.save(os.path.join(DATA_PATH, "coef_array_iphone.npy"), coef_array)

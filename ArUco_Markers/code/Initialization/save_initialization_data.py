...
cameraMatrix = np.load(os.path.join(DATA_PATH, "realsense_camera_matrix.npy"))
distCoeffs = np.load(os.path.join(DATA_PATH, "realsense_distCoeffs.npy"))
...
try:
    ...
    # Stop pipeline
    np.save(os.path.join(DATA_PATH, "pose_matrix.npy"), X)
    np.save(os.path.join(DATA_PATH, "tvec_array.npy"), tvec_array)
    pipe.stop()

...
load data_new/motion_array_all.txt
load data_new/pred_array_all.txt
data_original = motion_array_all;
...
h_frame_text = text(0, 0, 0, sprintf('Frame: 1'), 'FontSize', 12, 'Color', 'k');
